...
import com.kolot.x_servicesbeta.com.kolot.x_servicesbeta.bantuan.ALERT_DIALOG_CLOSE
import com.kolot.x_servicesbeta.com.kolot.x_servicesbeta.bantuan.ALERT_DIALOG_DELETE
...
import com.kolot.x_servicesbeta.com.kolot.x_servicesbeta.bantuan.RESULT_ADD
...
class BuatPesanan : AppCompatActivity(), View.OnClickListener {
    ...
    private var quote: Pesanan? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isEdit) {
            actionBarTitle = "Perbarui Pesanan"
            btnTitle = "Perbarui Pesanan"
            quote?.let {
                binding.edtTitle.setText(it.title)
                binding.edtDescription.setText(it.description)
            }!!
        } else {
            actionBarTitle = "Buat Pesanan"
            btnTitle = "Pesan"
        }
    ...
    private fun getCategories(): ArrayList<String> {
        ...
        firestore.collection("categories")
                ...
                .addOnFailureListener { exception ->
                    Toast.makeText(this@BuatPesanan, "Categories cannot be retrieved ", Toast.LENGTH_SHORT).show()
                }
    ...
    override fun onClick(view: View) {
        ...
        if (view.id == R.id.btn_submit) {
            ...
            if (isEdit) {
                ...
                firestore.collection("pesanan").document(quote?.id.toString())
                        .set(user)
                        ...
                        .addOnFailureListener { e ->
                            Toast.makeText(this@BuatPesanan, "Gagal mengupdate data", Toast.LENGTH_SHORT).show()
                        }
                ...
                firestore.collection("pesanan")
                        ...
                        .addOnSuccessListener { documentReference ->
                            Toast.makeText(this@BuatPesanan, "DocumentSnapshot added with ID: ${documentReference.id}", Toast.LENGTH_SHORT).show()
                            setResult(RESULT_ADD, intent)
                            finish()
                        }
                        .addOnFailureListener { e ->
                            Toast.makeText(this@BuatPesanan, "Error adding document", Toast.LENGTH_SHORT).show()
                        }
    ...
    private fun showAlertDialog(type: Int) {
        ...
        if (isDialogClose) {
            ...
            dialogTitle = "Pembatalan Pesanan"
        }
                ...
                if (isDialogClose) {
                    ...
                    firestore.collection("pesanan").document(quote?.id.toString())
                            ...
                            .addOnFailureListener { e ->
                                ...
                                Toast.makeText(this@BuatPesanan, "Gagal menghapus data", Toast.LENGTH_SHORT).show()
                            }
